        ...
        <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-[#FBFAF6] border-2 border-[#E8D399] rounded-xl focus:outline-none focus:border-[#0B2559] focus:bg-white text-sm font-bold text-black"
          ...
          <div className="grid grid-cols-2 gap-3">
              ...
              {categoryMode === 'select' ? (
                <div className="flex gap-1">
                  <select
                    ...
                    className="flex-1 w-full px-3 py-3 bg-[#FBFAF6] border-2 border-[#E8D399] rounded-xl focus:outline-none focus:border-[#0B2559] focus:bg-white text-xs font-bold appearance-none text-black"
                  >
                  ...
                  <button
                    ...
                    className="px-2.5 py-3 text-xs font-black text-[#0B2559] bg-[#FBFAF6] border-2 border-[#E8D399] rounded-xl hover:bg-amber-100 transition-colors shrink-0"
                ...
                <div className="flex gap-1">
                  <input
                    ...
                    value={formData.category}
                    onChange={e => setFormData({...formData, category: e.target.value})}
                    className="flex-1 w-full px-3 py-3 bg-[#FBFAF6] border-2 border-[#E8D399] rounded-xl focus:outline-none focus:border-[#0B2559] focus:bg-white text-xs font-bold text-black"
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-[#FBFAF6] border-2 border-[#E8D399] rounded-xl focus:outline-none focus:border-[#0B2559] focus:bg-white text-sm font-bold text-right text-black"
                placeholder="0"
                required
              />
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-[#FBFAF6] border-2 border-[#E8D399] rounded-xl focus:outline-none focus:border-[#0B2559] focus:bg-white text-sm font-bold text-black"
                placeholder="5"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 w-full py-3.5 bg-[#0B2559] border border-[#D4AF37] hover:bg-[#164AAB] text-[#D4AF37] rounded-xl text-xs font-black tracking-wider transition-all disabled:opacity-50 shadow-md cursor-pointer"
          >
