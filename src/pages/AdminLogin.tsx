...
export default function AdminLogin() {
  ...
  return (
    <div className="relative h-screen max-h-screen min-h-screen overflow-y-auto lg:overflow-hidden bg-white p-3 sm:p-5 lg:p-6 font-sans flex items-center justify-center">
      <div className="relative grid w-full max-w-4xl max-h-[92vh] overflow-hidden rounded-3xl border border-gray-200/90 bg-[#123E94] shadow-[0_25px_60px_-12px_rgba(0,0,0,0.25),0_12px_28px_-6px_rgba(0,0,0,0.15)] lg:grid-cols-[0.85fr_1.15fr]">
        <div className="hidden flex-col justify-between bg-[#0B2559] border-r border-[#D4AF37]/20 p-6 lg:p-8 text-white lg:flex overflow-y-auto hide-scrollbar">
          <div>
            <div className="mb-5 inline-flex items-center gap-2 rounded-2xl bg-[#123E94] border border-[#D4AF37]/40 px-3.5 py-2 shadow-xl">
        ...
        <div className="p-5 sm:p-7 lg:p-8 bg-white text-[#0F172A] overflow-y-auto hide-scrollbar flex flex-col justify-center">
          {/* Brand */}
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-3.5">
            <p className="text-xs font-bold text-[#0F172A]">{l('Enter your portal credentials', 'உங்கள் பயனர் விவரங்களை உள்ளிடவும்')}</p>
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border-2 border-[#E8D399] bg-[#FBFAF6] px-3.5 py-2.5 sm:py-3 text-xs sm:text-sm font-semibold outline-none transition-colors placeholder:text-[#AAA69C] focus:border-[#0B2559] focus:bg-white text-[#0F172A]"
                value={portalId}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border-2 border-[#E8D399] bg-[#FBFAF6] px-3.5 py-2.5 sm:py-3 pr-11 text-xs sm:text-sm font-semibold outline-none transition-colors placeholder:text-[#AAA69C] focus:border-[#0B2559] focus:bg-white text-[#0F172A]"
                  value={password}
                ...
                <button
                  ...
                  className="absolute right-2 top-1/2 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-lg text-[#6B7280] hover:bg-[#F9FAFB] hover:text-[#0F172A] cursor-pointer"
            ...
            <button
              type="submit"
              disabled={loading}
              className="group flex w-full items-center justify-center gap-2 rounded-xl bg-[#0B2559] border border-[#D4AF37] py-3 font-black text-xs sm:text-sm text-[#D4AF37] shadow-lg shadow-black/20 transition-all hover:bg-[#164AAB] hover:scale-[1.01] active:scale-[0.99] disabled:opacity-60 cursor-pointer"
            >
              {loading ? (
                <>
